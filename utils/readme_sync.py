...
def main():
    github_raw_readme_url = (
        "https://raw.githubusercontent.com/hotchpotch/JaCWIR/main/README.md"
    )
    hf_raw_readme_url = (
        "https://huggingface.co/datasets/hotchpotch/JaCWIR/resolve/main/README.md"
    )
